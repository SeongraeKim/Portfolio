...
/* onClick='location.href='${contextPath}/main/qnaInto.do?qnaNum='" + data[i].qnaNum + "'*/
		...
		function postMessage() {
	        ...
	        xmlhttp.open("POST", "http://localhost:8090/odetour0316/shoutServlet");
	        xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
	        var messageText = escape(document.getElementById("textMessage").value);
	    ...
	    function getMessages(){
	        if(!messagesWaiting){
	            ...
	            xmlhttp.open("GET", "http://localhost:8090/odetour0316/shoutServlet");
	            xmlhttp.send();
	        }
	    }
