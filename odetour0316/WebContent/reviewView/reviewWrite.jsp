...
<body>
	...
	<table class="table" style="width: 80%; margin-left:auto; margin-right:auto; text-align: center;">
		<tr>
			...
			<td style="width: 80%; text-align:left; border-top:none;">
				<input id="title" name="title" type="text" placeholder="제목을  입력해 주세요. (35자이내)"  maxlength="35" style="border:none; width:700px; background-color:#ffffff;"/>
			</td>
		</tr>
		<tr>
			...
			<td style="width: 80%; text-align:left; padding-top: 10px; padding-left: 0px; padding-right:10px;">
				<textarea id="content" class="form-control" rows="15" cols="100" placeholder="리뷰를 남겨주세요..." name="content" maxlength="2048" style="height: 350px"></textarea>
			</td>
		</tr>
		<tr>
			<td style="width: 300px; text-align:left;">
				<input type="file" name="imageFileName" onchange="readURL(this);" style="background-color:#dddddd;"/>
			</td>
