...
<script type="text/javascript">
	...
	function modify_enable(obj){// 수정하기 클릭시 form input 창 활성화 
		...
		document.getElementById("re_imageFileName").disabled=false; 
		$("#current_btn").hide();
	...
	function click_modify_cancle(obj){//수정하기 취소
		...
		document.getElementById("re_imageFileName").disabled=true; 
...
<body>
	...
	<div class="container">
		...
		<table class="table" id="review" style="width: 90%; text-align:center; margin-left: 40px;">
			<tr>
			...
			<tr>
				<td style="width:20%; text-align:left;"><i class="far fa-check-circle fa-lg mr-2 ml-5"></i><b>작성자</b></td>
				<td style="width:30%; text-align:left;"><b>${reviewView.writer}</b></td>
				<td style="width:20%; text-align:left;"><i class="far fa-check-circle fa-lg mr-2 ml-5"></i><b>작성일</b></td>
				<td style="width:30%; text-align:left;"><b>${reviewView.writeDate}</b></td>
			</tr>		
			<tr>
				
				<td style="width:20%; text-align:left;"><i class="far fa-check-circle fa-lg mr-2 ml-5"></i><b>제 목</b></td>
				<td colspan="3" style="width:80%; text-align:left;">
					<input type="text" id="re_title" name="title" value="${reviewView.title}" style="width:600px; border:none;" readonly/>
				</td>
			</tr>	
			<tr>
				<td style="width:20%; text-align:left;"><i class="far fa-check-circle fa-lg mr-2 ml-5"></i><b>리 뷰</b></td>
				<td colspan="3" style="padding-top:10px; padding-left:0; padding-bottom:0;">
					<textarea class="form-control" id="re_content" name="content" rows="15" cols="100" maxlength="2048" placeholder="" style="width:97%; text-align:left; border:none; background-color:#ffffff; resize:none;" readonly>${reviewView.content}</textarea>
				</td>
			</tr>
			<tr>
				<td style="width:20%; text-align:left;"><i class="far fa-file-alt fa-lg mr-2 ml-5"></i><b>첨부파일</b></td>
				<td colspan="3" style="width:80%; text-align:left;">
					<input type="text" name="imageFileName" value="${reviewView.imageFileName}" disabled style="width:94%; border:none; background-color:#ffffff;">
				</td>
			</tr>
			<tr>
				<td style="border-top:none; width:20%; text-align:right;">
					<input type="file" id="re_imageFileName" name="imageFileName" value="${reviewView.imageFileName}" onchange="readURL(this);" disabled onclick="modify_image(this.form)">
				</td>
				<td colspan="3" style="border-top:none; width:80%; text-align:left;">
					<img src="${imageFilePath}/upload/${reviewView.email}/${reviewView.imageFileName}" width="650" height="400" />
					
					
				</td>
			</tr>
			<tr>
				<td id="editFile" style="border-top:none; width:20%; text-align:right;">
				</td>
				<td colspan="3" style="border-top:none; width:80%; text-align:left;">
		...
		<div style="width:81%; text-align:right;">
			<div id="current_btn">	
				<c:if test="${sessionEmail == reviewView.email}">
					<input type="button" class="btn btn-info active" value="수정하기" onclick="modify_enable(this.form)"/>
		...
		<table class="table" id="commentListArea" style="width:90%; text-align:center; margin-left:40px;">
			<tr>
				<td style="width:13%"><b>작성자</b></td>
				<td style="width:37%;"><b>댓 글</b></td>
				<td style="width:13%"><b>작성일</b>
				...
				<c:when test="${recommentList != null }">
					<c:forEach var="recommentList" items="${recommentList}" varStatus="num">
					 	<tr id="commentArea${num.index}"> 
							...
							<td><input type="text" id="comment${num.index}" value="${recommentList.content}" name="recontent" disabled style="border:none; background-color:#ffffff; width:450px;"></td>
							<td><b>${recommentList.writeDate }</b></td>
