			...
			<table class="table" style="margin-left:auto; margin-right:auto; width:80%; text-align:center;" >
				...
				<tr>
					<td style="width: 15%; text-align:left; border-top:none;">
						<i class="far fa-check-circle fa-lg mr-2 ml-2"></i><b>작성자</b>
					</td>
					<td style="width:85%; text-align:left; border-top:none;">
						<input name="writer" type="text" value="${sessionScope.name}" readonly="readonly" style="border:none; width:300px; margin-left: 22px; background-color:#ffffff;"/>
					</td>
				</tr>
				<tr>
					<td style="width: 15%; text-align:left;">
						<i class="far fa-check-circle fa-lg mr-2 ml-2"></i><b>공지제목</b>
					</td>
					<td style="width:85%; text-align:left;">
						<input name="title" type="text" placeholder="40자 이내로 입력" maxlength="40" style="border:none; width:600px; margin-left: 22px; background-color:#ffffff;"/>
					</td>
				</tr>
				<tr>
					<td style="width: 15%; text-align:left;">
					...
					<td style="width:85% text-align:left; padding-top:10px; padding-left:20px;">
						<textarea class="form-control" name="content" rows="15" cols="90" placeholder="공지사항 내용 입력" maxlength="2048" style="border:none; height: 350px;"></textarea>
					</td>
				</tr>
			</table>	
