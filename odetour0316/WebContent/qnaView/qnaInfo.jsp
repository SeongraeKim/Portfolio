...
<body>
	...
	<div class="container">
		...
		<table class="table" id="notice" style="margin-left:auto; margin-right:auto; width:80%; text-align:center; font-size: 20px;" >
			...
			<tr>
				<td style="text-align:left;"><i class="far fa-check-circle fa-lg mr-2 ml-5"></i><b>고객명</b></td>
			...
			<tr>
				<td style="width:25%; text-align:left;"><i class="far fa-check-circle fa-lg mr-2 ml-5"></i><b>문의사항</b></td>
			...
			<tr>
				<td style="width:25%; text-align:left;"><i class="far fa-check-circle fa-lg mr-2 ml-5"></i><b>문의내용</b></td>
				<td colspan="3">
