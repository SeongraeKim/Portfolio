...
<head>
	...
	<style type="text/css">
		.bx-wrapper .bx-prev{position: absolute; top: 300px; left: 80px;}
		.bx-wrapper .bx-next{position: absolute; top: 300px; right: 80px;}
	...
	<div class="navbar navbar-expand sticky-top navbar-dark bg-dark">
	    <div class="navbar-nav">
	        <ul class="navbar-nav" style="font-size: 20px;">
	            ...
	            <li class="nav-item">
	                <a class="nav-link" href="cafe/cafe_center.jsp">Cafe</a>
	            </li>
	            <li class="nav-item">
